/**
 * Render MVP-TECHNICAL-DOCUMENTATION.md → PDF with Mermaid diagrams (in-browser via jsDelivr).
 * From repo root: deno run -A docs/render-pdf.ts
 *
...
/** Replace ```mermaid fences with raw HTML placeholders (marked preserves inline HTML). */
...
const mdPath = `${root}MVP-TECHNICAL-DOCUMENTATION.md`;
const outPdf = `${root}MVP-TECHNICAL-DOCUMENTATION.pdf`;
...
<head>
  <meta charset="utf-8"/>
  <title>MVP Technical Documentation</title>
  <style>
